...
public interface InventoryContents {
    ...
    Optional<ClickableItem> get(libs.fr.minuskube.inv.content.SlotPos slotPos);

    InventoryContents set(int row, int column, ClickableItem item);
    InventoryContents set(libs.fr.minuskube.inv.content.SlotPos slotPos, ClickableItem item);
    ...
    InventoryContents fillRect(libs.fr.minuskube.inv.content.SlotPos fromPos, libs.fr.minuskube.inv.content.SlotPos toPos, ClickableItem item);
    ...
    class Impl implements InventoryContents {
        ...
        @Override
        public Optional<ClickableItem> get(libs.fr.minuskube.inv.content.SlotPos slotPos) {
        ...
        @Override
        public InventoryContents set(libs.fr.minuskube.inv.content.SlotPos slotPos, ClickableItem item) {
