...
public class FreezeCommandExecutor implements CommandExecutor, TabCompleter {

	private final GameManager gameManager;

	public FreezeCommandExecutor(GameManager gameManager){
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args){
		...
		FreezeHandler.get().freeze(target);

		player.sendMessage("You have frozen " + uhcTarget.getName());
		return true;
	}
