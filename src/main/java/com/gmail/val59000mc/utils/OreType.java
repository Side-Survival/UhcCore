...
public enum OreType {
    ...
    COPPER(         UniversalMaterial.COPPER_INGOT,     UniversalMaterial.COPPER_ORE,   UniversalMaterial.DEEPSLATE_COPPER_ORE,     false),
    LAPIS_LAZULi(   UniversalMaterial.LAPIS_LAZULI,     Material.LAPIS_ORE,             UniversalMaterial.DEEPSLATE_LAPIS_ORE,      false),
    IRON(           UniversalMaterial.IRON_INGOT,       Material.IRON_ORE,              UniversalMaterial.DEEPSLATE_IRON_ORE,       false),
    GOLD(           UniversalMaterial.GOLD_INGOT,       UniversalMaterial.GOLD_ORE,     UniversalMaterial.DEEPSLATE_GOLD_ORE,       false),
    ...
    NETHER_GOLD(    UniversalMaterial.GOLD_INGOT,       UniversalMaterial.NETHER_GOLD_ORE,      null,                       false),
    ANCIENT_DEBRIS( UniversalMaterial.NETHERITE_SCRAP,  UniversalMaterial.ANCIENT_DEBRIS,       null,                       false);
